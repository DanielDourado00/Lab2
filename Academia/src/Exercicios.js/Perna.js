...
const initialLegExercises = [
    ...
    'Extensão de Pernas - 3 séries de 15 repetições',
    'Flexão de Pernas - 3 séries de 15 repetições',
    'Elevação de Panturrilha - 4 séries de 20 repetições',
];

export default function TelaInicio() {
    const [activeExercises, setActiveExercises] = useState(
        initialLegExercises.map((name, index) => ({ name, index }))
    );
        ...
        >
            <View style={styles.container}>
                <View style={styles.content}>
                    <Text style={styles.title}>Treino de Perna</Text>
